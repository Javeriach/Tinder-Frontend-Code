...
function ChatsContainer() {
    ...
    return (
        <div className="pt-[70px] bg-white overflow-hidden flex-1 flex-col md:flex   duration-100 ">
            {/* CHAR USER */}
            {messagesLoading ? <div className="flex justify-center items-center h-full w-fukk
            "><Lottie animationData={message_loading}/></div> :
                <>
           <ChatHeader contactData={currentChatData?.friendData? currentChatData.friendData[0]:[]} />
