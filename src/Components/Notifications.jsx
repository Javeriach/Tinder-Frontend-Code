    ...
    <>
      ...
      >
        <Link to={"/chat"} class="relative">
          ...
          <div class="px-1 py-0.5 bg-pink-500 min-w-5 rounded-full text-center text-white text-xs absolute -top-2 -end-1 translate-x-1/4 text-nowrap">
            <div class="absolute top-0 start-0 rounded-full -z-10 animate-ping bg-pink-400 w-full h-full"></div>
      ...
      <div className="hidden md:block dropdown dropdown-end">
        ...
        >
          <div tabIndex={0} className="card-body">
            <div class="block px-4 py-2 font-medium text-center text-white rounded-t-lg  bg-pink-500 dark:text-white">
              Notifications
            </div>
