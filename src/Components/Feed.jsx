...
function Feed() {
  ...
  return (
    <div className="md:justify-center bg-lime-700 py-11 min-h-screen h-full pt-[100px] grid place-items-center"  style={{background: `linear-gradient(0deg, rgba(253,120,87,1) 0%, rgba(253,41,125,1) 100%)`}}>
      {
